        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="feature-item bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600 font-playfair mb-6">
              ...
              customers in many cities! Delivery is one of our newest offerings
              aimed at making sourcing local flowers as simple as possible for
              our customers. To learn more or get on our list, sign up below.
            </p>
            <Button
              size="lg"
          ...
          <div className="feature-item bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600 font-playfair mb-6">
              ...
              tapestry of flower businesses in your region to buy and sell high
              quality, traceable floral supply.
            </p>
            <Button
              size="lg"
              className="border border-gray-300 bg-input/30 shadow-xs hover:bg-background/5 hover:border-gray-200 cursor-pointer"
